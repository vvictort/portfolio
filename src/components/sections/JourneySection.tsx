...
export function JourneySection() {
  const skills = {
    LANGUAGES: [
      ...
      { name: "TypeScript", status: "CLIMBING", active: false },
      { name: "JavaScript", status: "CLIMBING", active: false },
      { name: "Python", status: "CLIMBING", active: false },
      { name: "R", status: "CLIMBING", active: false },
      { name: "HTML/CSS", status: "CRUISING", active: true },
    ],
    FRAMEWORKS: [
      { name: "React", status: "CLIMBING", active: false },
      { name: "Tailwind CSS", status: "CLIMBING", active: false },
      { name: "Node.js", status: "CLIMBING", active: false },
      { name: "Astro", status: "TAXIING", active: true },
      { name: "ThreeJS", status: "TAXIING", active: true },
    ],
    "TOOLS & OTHER": [
      { name: "Git", status: "CLIMBING", active: false },
      { name: "scikit-learn", status: "CLIMBING", active: false },
      { name: "Jupyter", status: "CLIMBING", active: false },
      { name: "Figma", status: "CLIMBING", active: false },
