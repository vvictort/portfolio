...
const buildMailtoHref = (email: string, state: FormState) => {
  const subject =
    state.subject.trim() ||
    `Portfolio inquiry from ${state.name.trim() || "your site"}`;
  const bodyLines = [
...
export function ContactSection() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const nextFallbackEmail =
          data?.fallbackEmail || (response.status >= 500 ? CONTACT_EMAIL : "");
        ...
        if (response.status >= 500) {
          throw new Error(
            buildDeliveryUnavailableMessage(nextFallbackEmail || CONTACT_EMAIL),
          );
        }
  ...
  const fallbackMailtoHref = fallbackEmail
    ? buildMailtoHref(fallbackEmail, formState)
    : "";
  const fieldSlotClassName = "relative mb-3";
  const fieldErrorClassName = "absolute top-full mt-1.5 left-1 text-[11px] leading-4 text-red-400";

  return (
    <div className="w-full max-w-6xl mx-auto px-8 py-28 flex flex-col gap-12">
      <motion.div
      ...
      >
        ...
        <p className="text-zinc-400 text-lg max-w-2xl leading-relaxed">
          Have a project in mind, want to collaborate, or just say hello? Send a
          transmission and I'll respond as soon as I land.
        </p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <form
            ...
            noValidate
            className="flex flex-col gap-4 relative z-10 font-mono text-sm"
          >
              ...
              <div className={fieldSlotClassName}>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#111] border rounded-lg py-4 pl-11 pr-4 text-white placeholder:text-zinc-600 focus:outline-none transition-colors ${fieldErrors.name
              ...
              <div className={fieldSlotClassName}>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#111] border rounded-lg py-4 pl-11 pr-4 text-white placeholder:text-zinc-600 focus:outline-none transition-colors ${fieldErrors.email
                        ? "border-red-500/60 focus:border-red-500/80"
                        : "border-white/10 focus:border-primary/50"
                      }`}
            ...
            <div className={fieldSlotClassName}>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#111] border border-white/10 rounded-lg py-4 pl-11 pr-4 text-white placeholder:text-zinc-600 focus:outline-none focus:border-primary/50 transition-colors"
            ...
            <div className={fieldSlotClassName}>
              <div className="relative group">
                <textarea
                  ...
                  className={`w-full min-h-[13rem] bg-[#111] border rounded-lg py-4 px-4 text-white placeholder:text-zinc-600 focus:outline-none transition-colors resize-none ${fieldErrors.message
                      ? "border-red-500/60 focus:border-red-500/80"
                      : "border-white/10 focus:border-primary/50"
                    }`}
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 cursor-pointer bg-primary/90 hover:bg-primary text-black font-bold uppercase tracking-widest px-6 py-4 rounded-lg transition-all shadow-[0_0_15px_rgba(250,204,21,0.2)] hover:shadow-[0_0_20px_rgba(250,204,21,0.4)] hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0"
            >
              <Send className="w-4 h-4" />
              <span>
            ...
            {submitMessage && (
              <p
                aria-live="polite"
                className={`text-xs leading-relaxed ${submitStatus === "error"
                    ? fallbackEmail
                      ? "text-primary/90"
                      : "text-red-400"
                    : "text-green-400"
        ...
        <div className="lg:col-span-2 flex flex-col gap-6 h-full">
          ...
          >
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6">
              View or download my complete resume with experience, education,
              and skills.
            </p>
